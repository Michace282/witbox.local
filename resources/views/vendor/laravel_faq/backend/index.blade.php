        ...
        <div class="cards-body">
            <div class="tabbable">
                <ul class="nav nav-tabs nav-tabs-bottom" id="faq_tab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#manage_tab" data-toggle="tab"><i class="fas fa-th-list"></i><span class="margin_right_5">Management</span></a></li>
                    ...
                    <li class="nav-item edit_faq_tab hidden">
                        <a href="#edit_faq" class="nav-link paddin_left_30" data-toggle="tab">
                            <span class="span_edit_faq_tab">Edit</span>
                        </a>
                    ...
                    <div class="tab-pane" id="add_faq">
                        ...
                        <form id="frm_create_faq" class="form-horizontal" name="frm_create_faq">
                            @if($multi_lang)
                                <div class="form-group row fg_lang">
                                    <label class="col-sm-2 control-label col-form-label label_post" for="lang">
                                        ...
                                        <span class="label_lang">Select Language</span>
                                    </label>
                                    <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-sm-12 col-md-3 control-label col-form-label label_post" for="description">Description</label>
                                <div class="col-6">
                            ...
                            <div class="form-group row fg_tag">
                                <label class="col-sm-2 control-label col-form-label label_post" for="title">
                                    <span class="more_info"></span>
                                    <span class="label_title">Select a tag</span>
                                </label>
                                <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                <button type="submit" class="float-right btn btn-success ml-2 add_submit_buttons"><i class="fa fa-save margin_left_8"></i>Store</button>
                                <button type="button" class="float-right btn bg-secondary color_white cancel_add_close_btn"><i class="fa fa-times margin_left_8"></i>Cancel</button>
                            </div>
                        </form>
                    </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-bottom" id="faq_tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#manage_tab_faq_item" data-toggle="tab">
                                        ...
                                        <span class="margin_right_5">Manage items</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item edit_faq_item_tab hidden">
                                    <a href="#edit_faq_item" class="nav-link paddin_left_30" data-toggle="tab">
                                        <span class="span_edit_faq_item_tab">Edit</span>
                                    </a>
